...
public enum ResponseCode {
    ...
    REQUEST_PARSE_ERROR(HttpResponseStatus.BAD_REQUEST, 10000, "请求解析错误, URL路径不合法"),
    ...
    PARSE_PROTOCOL_ERRPR(HttpResponseStatus.BAD_REQUEST, 10008, "解析协议异常"),
    ...
    LIMIT_REQUEST(HttpResponseStatus.FORBIDDEN,20001, "请求达到限制")
