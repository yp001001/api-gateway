...
public interface FilterConst {
    ...
    int LIMIT_FILTER_ORDER = Integer.MIN_VALUE;
    ...
    String ROUTER_DUBBO_FILTER_ID = "router_dubbo_filter";
    String ROUTER_DUBBO_FILTER_NAME = "router_dubbo_filter";
    int ROUTER_DUBBO_FILTER_ORDER = Integer.MAX_VALUE;
}
